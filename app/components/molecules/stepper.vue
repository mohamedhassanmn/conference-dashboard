...
import StepperItem from '~/components/atoms/stepperItem.vue'

const props = defineProps({
    steps: {
        type: Array as () => Array<{ stepCount: number; stepName: string }>,
        required: true,
    },
    activeStep: {
        type: Number,
...
<template>
    <div class="flex w-full max-w-[80%] mx-auto justify-between items-center bg-primary-100 p-4 rounded-2xl">
